...
class TestOnlineStore(unittest.TestCase):
    ...
    def test_4(self):
        ...
        payment = c.Item(type='payment', description='invoice_4', amount=1e16, quantity=1)
        reimbursement = c.Item(type='payment', description='reimbursement_4', amount= -1e16, quantity=1)
    ...
    def test_5(self):
        small_item = c.Item(type='product', description='accessory', amount=1e16, quantity=1)
        payment_1 = c.Item(type='payment', description='invoice_5_1', amount=5*1e15, quantity=1)
        payment_2 = c.Item(type='payment', description='invoice_5_2', amount=5*1e15, quantity=1)
